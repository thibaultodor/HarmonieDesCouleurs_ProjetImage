...
#include <memory>
#include "../HarmonieDesCouleurs/fancyslider.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FancySlider_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_FancySlider_t qt_meta_stringdata_FancySlider = {
    {
QT_MOC_LITERAL(0, 11) // "FancySlider"
...
const QMetaObject FancySlider::staticMetaObject = { {
    QMetaObject::SuperData::link<QSlider::staticMetaObject>(),
    qt_meta_stringdata_FancySlider.offsetsAndSize,
    qt_meta_data_FancySlider,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_FancySlider_t
, QtPrivate::TypeAndForceComplete<FancySlider, std::true_type>
